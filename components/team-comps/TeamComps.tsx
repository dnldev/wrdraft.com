    ...
    <div className="space-y-12">
      <Card className="p-0">
        ...
        <CardBody className="p-4 md:p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
          {teamComps.map((comp) => (
            <Card
              key={comp.archetypeId}
              className={`p-6 bg-content1 border-t-4 ${
                archetypeColors[
                  comp.archetypeId as keyof typeof archetypeColors
                ]
              }`}
            >
              ...
              <p className="mb-4 text-sm font-light italic text-foreground/60">
                {comp.description}
              </p>
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <div>
                    <p className="text-xs uppercase text-foreground/60 font-bold mb-1">
                      ADCs
                    </p>
                    <div className="flex flex-wrap gap-1">
                      {comp.coreChampions.adcs.map((name) => (
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {comp.coreChampions.supports.map((name) => (
                        <Chip key={name} size="sm">
                          {name}
                        </Chip>
                      ))}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {comp.synergisticAllies.map((name) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {comp.hardCounters.map((name) => (
                    <Chip key={name} size="sm" color="danger" variant="flat">
                      {name}
                    </Chip>
                  ))}
                </div>
